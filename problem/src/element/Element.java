...
public class Element {
	...
	public final double alfa;				//wspołczynnik wymiany ciepła
	public final double specificHeat;		//ciepło właściwe
	public final double conductivity;		//współczynnik przewodzenia ciepła
	public final double density;			//gęstość
